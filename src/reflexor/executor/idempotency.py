"""Idempotency caching primitives (application port).

The executor should prevent duplicate side effects by caching outcomes under an idempotency key.
This module defines an application-layer port; persistence is provided by infrastructure adapters.
...
class IdempotencyLedger(Protocol):
    """Application port for durable idempotency tracking and cached outcomes."""
